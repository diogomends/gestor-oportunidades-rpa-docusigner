...
2. **`tests/robot/browser/docusign.test.js`**
   - 12 testes executados e aprovados (incluindo testes de storageState, redirect duplo, login, extração OneDS via `data-qa` da linha e botão de subject, e a suíte de paginação de acordos).
