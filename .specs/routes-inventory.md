...
| GET | `/api/contracts` | Listar contratos | protect + perm contracts:view | `src/modules/contract/routes.js:107` | — |
| GET | `/api/contracts/:id` | Detalhar contrato | protect + perm contracts:view | `src/modules/contract/routes.js:113` | — |
| GET | `/api/contracts/:id/compatible-opportunities` | Listar oportunidades compativeis | protect + perm contracts:view | `src/modules/contract/routes.js:159` | — |
| GET | `/api/contracts/:id/files/:fileType/:fileIndex/download` | Baixar anexo do contrato | protect + perm contracts:download | `src/modules/contract/routes.js:136` | — |
| GET | `/api/contracts/:id/files/:fileType/:fileIndex/view` | Visualizar anexo do contrato | protect + perm contracts:view | `src/modules/contract/routes.js:129` | — |
| GET | `/api/contracts/uploads/inspect` | Inspecionar uploads no disco | protect + perm contracts:view | `src/modules/contract/routes.js:93` | — |
| GET | `/api/docusign/consent-url` | Obter URL de consentimento DocuSign | protect + perm docusign:manage | `src/modules/docusign/routes.js:25` | — |
| GET | `/api/docusign/download/:contractId` | Baixar documentos assinados | protect + perm docusign:manage | `src/modules/docusign/routes.js:30` | — |
| GET | `/api/docusign/portal/:hash` | Portal publico: dados do envelope | Publico | `src/modules/docusign/routes.js:21` | Publico por hash |
| GET | `/api/docusign/portal/:hash/download` | Portal publico: download doc assinado | Publico | `src/modules/docusign/routes.js:23` | Publico por hash |
| GET | `/api/docusign/signing-url/:contractId` | URL de assinatura para o signer | protect + perm docusign:manage | `src/modules/docusign/routes.js:29` | — |
| GET | `/api/docusign/status/:contractId` | Status do envelope DocuSign | protect + perm docusign:manage | `src/modules/docusign/routes.js:28` | — |
| GET | `/api/gestor-token` | Listar tokens | protect + perm gestor-token:manage | `src/modules/gestor-token/routes.js:19` | — |
| GET | `/api/gestor-token/active` | — | protect | `src/modules/gestor-token/routes.js:12` | — |
| GET | `/api/gestor-token/supervisores` | Listar supervisores | protect | `src/modules/gestor-token/routes.js:14` | — |
| GET | `/api/gestor-token/ufs` | Listar UFs disponiveis | protect | `src/modules/gestor-token/routes.js:13` | — |
...
| GET | `/api/system-config` | Obter config global do sistema | protect + perm system_config:manage | `src/modules/config-sistema/routes.js:22` | — |
| GET | `/api/system-config/access-violations` | Listar violacoes de acesso | protect + perm system_config:manage | `src/modules/config-sistema/routes.js:26` | — |
| GET | `/api/system-config/ui-visibility` | Obter visibilidade de UI | protect | `src/modules/config-sistema/routes.js:33` | — |
...
| POST | `/api/contracts` | Criar contrato (com PDFs) | protect + perm contracts:create | `src/modules/contract/routes.js:100` | — |
| POST | `/api/contracts/:id/files/clientDocs/:docType` | Upload doc do cliente | protect + perm contracts:upload | `src/modules/contract/routes.js:150` | — |
...
| POST | `/api/docusign/portal/:hash/upload` | Portal publico: upload de documento | Publico | `src/modules/docusign/routes.js:22` | Publico por hash |
| POST | `/api/docusign/resend/:contractId` | Reenviar envelope (novo signer) | protect + perm contracts:docusign_resend | `src/modules/docusign/routes.js:27` | — |
| POST | `/api/docusign/send/:contractId` | Enviar contrato para DocuSign | protect + perm contracts:docusign | `src/modules/docusign/routes.js:26` | — |
| POST | `/api/docusign/webhook` | Webhook de eventos DocuSign | Publico | `src/modules/docusign/routes.js:31` | Callback externo DocuSign |
| POST | `/api/gestor-token` | Criar token | protect + perm gestor-token:manage | `src/modules/gestor-token/routes.js:20` | — |
| POST | `/api/gestor-token/resolve` | Resolver token existente | protect | `src/modules/gestor-token/routes.js:15` | — |
...
| PUT | `/api/contracts/:id` | Atualizar contrato | protect + perm contracts:upload | `src/modules/contract/routes.js:119` | — |
| PUT | `/api/contracts/:id/opportunity` | Vincular oportunidade ao contrato | protect + perm contracts:upload | `src/modules/contract/routes.js:166` | — |
| PUT | `/api/gestor-token` | — | protect + perm gestor-token:manage | `src/modules/gestor-token/routes.js:24` | — |
...
| PUT | `/api/system-config` | Atualizar config global do sistema | protect + perm system_config:manage | `src/modules/config-sistema/routes.js:23` | — |
| PUT | `/api/system-config/ui-visibility` | Atualizar visibilidade de UI | protect + perm system_config:manage | `src/modules/config-sistema/routes.js:34` | — |
...
| DELETE | `/api/contracts/:id` | Deletar contrato | protect + perm contracts:delete | `src/modules/contract/routes.js:126` | — |
| DELETE | `/api/contracts/:id/files/:fileType/:fileIndex` | Deletar anexo especifico | protect + perm contracts:delete | `src/modules/contract/routes.js:143` | — |
| DELETE | `/api/gestor-token` | — | protect + perm gestor-token:manage | `src/modules/gestor-token/routes.js:25` | — |
